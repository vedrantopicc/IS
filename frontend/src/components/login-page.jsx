...
export default function LoginPage() {
    ...
    const validateForm = () => {
        ...
        if (!formData.email) {
            newErrors.email = "Email ili korisničko ime je obavezno";
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.success(`Dobrodošli nazad, ${user.name || user.username}!`);
            ...
            const message = error.message || "Prijava nije uspjela. Molimo provjerite svoje podatke.";
                ...
                <Card className="rounded-2xl border border-white/40 bg-white/70 backdrop-blur-xl shadow-2xl">
                    <CardHeader className="text-center pt-10 pb-6 space-y-2">
                        ...
                        <CardDescription className="text-gray-600">
                            Svi studentski događaji na jednom mjestu
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        id="email"
                                        type="text"
                                        placeholder="Unesite korisničko ime/email"
