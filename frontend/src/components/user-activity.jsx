    ...
    return (
        <div className="w-full h-full min-h-[420px] flex flex-col bg-white p-6 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-8 px-2">
                <div>
                    <h2 className="text-xl font-extrabold text-slate-800 tracking-tight">Aktivnost korisnika</h2>
                    <p className="text-[12px] text-emerald-600 font-bold uppercase tracking-widest">Analitika rasta</p>
                </div>
                ...
                <div className="flex bg-slate-100/80 p-1.5 rounded-2xl border border-slate-200 shadow-inner">
                    {["daily", "weekly", "monthly", "yearly"].map((p) => (
                        <button
                            key={p}
                            onClick={() => setPeriod(p)}
                            className={`px-4 py-2 text-[10px] font-bold uppercase rounded-xl transition-all duration-300 ${period === p
                    ...
                    <ResponsiveContainer width="100%" height="95%">
                        ...
                        >
                            ...
                            <Tooltip
                                ...
                                labelFormatter={(value) => `Vrijeme: ${formatXAxis(value)}`}
                            />
