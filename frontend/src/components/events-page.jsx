...
export const EventsPage = () => {
    ...
    const cards = useMemo(() => {
        ...
        return rows.map((e) => ({
            ...
            location: e.location,
            date: e.dt
                ? e.dt.toLocaleDateString('sr-Latn-RS', {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                })
                : "",
            time: e.dt
                ? e.dt.toLocaleTimeString('sr-Latn-RS', { hour: "2-digit", minute: "2-digit" })
                : "",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50">
          ...
          <span className="rounded-full border border-gray-200 bg-white px-3 py-1">
            {cards.length} rezultata
          </span>
          <span className="rounded-full border border-gray-200 bg-white px-3 py-1">
            Sortiraj:{" "}
          
            <span className="font-medium text-gray-900">
              {sort === "date_asc" ? "Najskoriji" : "Najdalji"}
            </span>
          </span>
        </div>*/}
                                </div>
                        ...
                        <div className="mb-5 rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm">
                            <div className="p-3 md:p-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
                                ...
                                <div className="flex flex-col gap-4 md:flex-row md:items-end md:flex-wrap">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <span className="text-xs font-semibold tracking-wide text-gray-600">Sortiraj</span>
                                    ...
                                    <div className="flex flex-col gap-1 w-full md:w-64">
                                        <span className="text-xs font-semibold tracking-wide text-gray-600">Pretraga</span>
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-3 text-gray-900">
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                ...
                                                {fromDate ? fmtDisplay(fromDate) : "Od datuma"}
                                            </Button>
                                        </PopoverTrigger>
                                    ...
                                    <Popover>
                                        <PopoverTrigger asChild>
                                            ...
                                            >
                                                <CalendarIcon className="mr-2 h-4 w-4" />
                                                {toDate ? fmtDisplay(toDate) : "Do datuma"}
                                            </Button>
                                        </PopoverTrigger>
                                        <PopoverContent className="!bg-gray-800 !border-gray-800" align="start">
                                            <Calendar
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-xs">
                                    {selectedCategoryLabel && (
                                        <span className="rounded-full border border-gray-200 bg-white px-3 py-1 text-gray-700">
                                            Kategorija: <span className="font-medium text-gray-900">{selectedCategoryLabel}</span>
                                        </span>
                                    )}

                                    {fromDate && (
                                        <span className="rounded-full border border-gray-200 bg-white px-3 py-1 text-gray-700">
                                            Od: <span className="font-medium text-gray-900">{fmtDisplay(fromDate)}</span>
                                        </span>
                                    )}

                                    {toDate && (
                                        <span className="rounded-full border border-gray-200 bg-white px-3 py-1 text-gray-700">
                                            Do: <span className="font-medium text-gray-900">{fmtDisplay(toDate)}</span>
                                        </span>
                                    )}

                                    {search?.trim() && (
                                        <span className="rounded-full border border-gray-200 bg-white px-3 py-1 text-gray-700">
                                            Pretraga: <span className="font-medium text-gray-900">"{search.trim()}"</span>
                                        </span>
                                    )}
                                </div>
                            </div>
                    ...
                    {loading ? (
                        ...
                        <div className="rounded-2xl border border-gray-200 bg-white p-10 text-center text-gray-600 shadow-sm">
                            Nema događaja koji odgovaraju vašim filterima.
                        </div>
                    ) : (
                        <>
