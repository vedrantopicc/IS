    ...
    const formatXAxis = (tickItem) => {
        ...
        switch (filter) {
            ...
            case "yearly":
                ...
                return months[parseInt(val) - 1] || val; // Pretvara broj u ime mjeseca
            default:
                return val;
        }
    };
                ...
                <div className="flex justify-between items-center mb-10">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 tracking-tight">Pregled rezervacija</h3>
                        </div>
                        <p className="text-gray-500 text-[15px] ml-10">Praćenje uspješnosti prodaje ulaznica</p>
                    </div>
                ...
                <div className="h-[400px] w-full">
                    {loading ? (
                        <div className="h-full flex flex-col items-center justify-center space-y-4">
                            ...
                            <p className="text-gray-400 font-medium">Analiziranje podataka...</p>
                        </div>
                    ) : data.length > 0 ? (
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={data} margin={{ top: 10, right: 30, left: -20, bottom: 20 }}>
                                ...
                                <XAxis
                                    // KLJUČNA PROMJENA: dataKey se mijenja na osnovu filtera
                                    dataKey={
                                        filter === "daily" ? "hour" :
                                            filter === "weekly" ? "day" :
                                    ...
                                    dy={10} // Pomjera tekst malo niže da ne udara u liniju
                                    interval={0} // Osigurava da se vide sve labele ako ima mjesta
                                />
                        ...
                        <div className="h-full flex flex-col items-center justify-center text-center">
                            <p className="text-gray-500 font-medium">Nema dostupnih rezervacija.</p>
                        </div>
                    )}
                </div>
            </div>
